...
int hardcode(Passenger* list, int tamList, int* id, int* contador)
{
    ...
    Passenger ePasajeroHarcodeado [] = {
        ...
        {0, "Julian", "Alvarez", 430000, "RTAN", 2, 1, 0},
        {0, "Lionel", "Messi", 1230000, "LSAN", 4, 1, 0},
        {0, "Juan", "Gomez", 970000, "CARP", 4, 1, 0},
        {0, "Lautaro", "Rodriguez", 158888, "FLY", 2, 1, 0},
        {0, "Mauricio", "Zan", 245000, "15AS", 1, 1, 0},
        {0, "Edgar", "Moreno", 10600, "NESM", 1, 1, 0},
        {0, "Alfred", "Constanzo", 15000, "PEPAX", 3, 1, 0},
        {0, "Franco", "Lopez", 500000, "ASDM", 4, 1, 0},
